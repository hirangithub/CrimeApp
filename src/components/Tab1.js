...
import ProfileImage from '../assets/p-3.jpg';
    ...
    return (             
        <div>
            <Box display="flex" sx={{ justifyContent: 'space-between', alignItems: 'center' }}>                     
                <Typography variant="h3" className="p-0">වින්දිතයන් පිළිබද විස්තර (1)</Typography> 
                <Button color="secondary" variant="contained">නව වින්දිතයන් ඇතුලත් කිරීම</Button>
            </Box>
            ...
            <div className="inner-holder">
              <Accordion expanded={expanded2 === 'panel1'} onChange={handleChangeAccordian('panel1')}>
                ...
                >
                    ...
                    <div>
                        <Typography variant="h3">සමන්ති කුමාරි පෙරේරා </Typography>
                        ...
                        <Box display="flex" sx={{ alignItems: 'center' }} className="sub-detail">                     
                          <div>
                              <Box display="flex" sx={{ alignItems: 'center' }} className="sub-detail">    
                                ...
                                <Typography variant="subtitle2"><MaleIcon /> Female</Typography> 
                              ...
                              <Box display="flex" sx={{ alignItems: 'center', marginTop: '.5rem' }} className="sub-detail">                     
                                <Typography variant="subtitle2"><WorkOutlineIcon /> පිළිගැනීමේ නිලධාරී </Typography> 
                              </Box> 
                          </div>  
                ...
                <AccordionDetails>
                    ...
                    <Box display="flex" sx={{ justifyContent: 'space-between', alignItems: 'end' }}>                     
                      <Typography variant="h4" className="p-0">ළගම ඥාතීන් පිළිබද විස්තර</Typography> 
