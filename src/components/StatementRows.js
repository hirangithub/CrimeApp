...
function createData(index, date, name, address, telephone, nic, passport, officerRank, officerNumber, officerName, officerTelephone, lastColumn) {
  return {
    index,
    date,
    name, 
...
const statementRows = [
  createData('00001', '03-04-2022', 'සමන් කුමාර','123/4 ජේතවන පාර, කොල්ලුපිටිය', '0773478734', '878787878V', 'N0000091919', 'SI', 'PS/01/02/03','අජිත් පෙරේරා', '0073473623', 'last column data'),
  ...
  return (
    <React.Fragment>
      {statementRows.map((row) => (
        ...
        <TableCell>{row.lastColumn}</TableCell>
      </TableRow>
                        ))}
